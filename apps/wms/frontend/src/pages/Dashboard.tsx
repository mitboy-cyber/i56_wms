...
export function DashboardPage() {
  const { data: stats } = useQuery<any>({ queryKey: ['dashboard-stats'], queryFn: () => client.get('/admin/api/dashboard/stats') });
  const { data: orders = [] } = useQuery<any[]>({ queryKey: ['dashboard-orders'], queryFn: () => client.get('/admin/api/orders') });
  const { data: parcels = [] } = useQuery<any[]>({ queryKey: ['dashboard-parcels'], queryFn: () => client.get('/admin/api/parcels') });
