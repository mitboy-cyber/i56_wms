// Package clientapi provides client portal JSON API handlers.
package clientapi
...
func RegisterClientAPI(
	...
	// Routes
	r.GET("/client/api/routes", ca(func(w http.ResponseWriter, req *http.Request) {
		routes, _, _ := rr.List(req.Context(), t, 0, 50)
...
// apiJSON helper used by client handlers.
